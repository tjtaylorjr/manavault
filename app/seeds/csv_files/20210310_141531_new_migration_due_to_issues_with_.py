...
def upgrade():
    ...
    sa.Column('is_companion', sa.Boolean(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['alternate_cardface_id'], ['alternate_cardfaces.id'], ),
    sa.ForeignKeyConstraint(['card_uuid'], ['cards.uuid'], ),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade():
    ...
    op.drop_index('ix_alternate_cardfaces_search_vector', table_name='alternate_cardfaces')
